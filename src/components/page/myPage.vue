      ...
      <template slot-scope="scope">
        <el-button
          ...
          @click="showEditDialog(scope.row.id)">编辑</el-button>
           ...
           <el-input   placeholder="请输入原密码" v-model="text1" show-password> <template slot="prepend">原密码 </template></el-input>
           <p>        </p>   
           <el-input   placeholder="请输入新密码" v-model="text2" show-password> <template slot="prepend">新密码 </template></el-input>
           <p>        </p>   
           <el-input   placeholder="请输入新密码" v-model="text3" show-password> <template slot="prepend">确认密码</template></el-input>
            <p>        </p>         
